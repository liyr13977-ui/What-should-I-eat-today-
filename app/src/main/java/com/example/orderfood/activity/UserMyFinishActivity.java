...
import com.example.orderfood.adapter.UserFinishAdapter;
...
public class UserMyFinishActivity extends BaseActivity {
    private SwipeRefreshLayout refreshLayout;
    private ListView orderList;
    private List<Food> Data;
    private UserFinishAdapter adapter;
    ...
    protected void initData() {
        ...
        List<Order> orderList1 = OrderDAO.getFinishOrder(String.valueOf(getUserId(this)));
        adapter=new UserFinishAdapter(this,orderList1);
        ...
        orderList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(selectedItem instanceof Order){
                    ...
                    Intent intent=new Intent(UserMyFinishActivity.this, OrderInfoActivity.class);
