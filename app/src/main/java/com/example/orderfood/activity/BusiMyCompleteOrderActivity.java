...
public class BusiMyCompleteOrderActivity extends BaseActivity implements BusiAllOrderAdapter.DataUpdateListener{
    ...
    protected int initLayout() {
        return R.layout.activity_busi_my_complete_order;
    }

    @Override
    protected void initView() {
        orderList=findViewById(R.id.lv_busi_my_completeOrder_foodlist);
        refreshLayout=findViewById(R.id.swipe_busi_my_completeOrder);
        sv=findViewById(R.id.sv_busi_my_completeOrder);
    }
        ...
        orderList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(selectedItem instanceof Order){
                    ...
                    Intent intent=new Intent(BusiMyCompleteOrderActivity.this, OrderInfo2Activity.class);
...
//        });
    ...
    public void loadData(){
        ...
        List<Order> orderList1 = OrderDAO.getCompleteOrderByBusiness(String.valueOf(getBusinessId(this)));
