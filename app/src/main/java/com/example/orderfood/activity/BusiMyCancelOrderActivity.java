...
public class BusiMyCancelOrderActivity extends BaseActivity implements BusiAllOrderAdapter.DataUpdateListener{
    ...
    protected int initLayout() {
        return R.layout.activity_busi_my_cancel_order;
    }

    @Override
    protected void initView() {
        orderList=findViewById(R.id.lv_busi_my_cancelOrder_foodlist);
        refreshLayout=findViewById(R.id.swipe_busi_my_cancelOrder);
        sv=findViewById(R.id.sv_busi_my_cancelOrder);
    }
        ...
        orderList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(selectedItem instanceof Order){
                    ...
                    Intent intent=new Intent(BusiMyCancelOrderActivity.this, OrderInfo2Activity.class);
...
//        });
    ...
    public void loadData(){
        ...
        List<Order> orderList1 = OrderDAO.getCancelOrderByBisiness(String.valueOf(getBusinessId(this)));
