...
public class UserMyAwaitingActivity extends BaseActivity implements UserAwaitingAdapter.OnEnsureClickListener {
    private SwipeRefreshLayout refreshLayout;
    private ListView orderList;
    private List<Food> Data;
    private UserAwaitingAdapter adapter;
        ...
        orderList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(selectedItem instanceof Order){
                    ...
                    Intent intent=new Intent(UserMyAwaitingActivity.this, OrderInfoActivity.class);
...
//        });
    ...
    public void loadData(){
        List<Order> orderList1 = OrderDAO.getAwaitingOrder(String.valueOf(getUserId(this)));
        adapter=new UserAwaitingAdapter(this,orderList1);
        // 设置回调接口
