...
public class BusiMyUnderwayOrderActivity extends BaseActivity implements BusiAllOrderAdapter.DataUpdateListener{
    ...
    protected int initLayout() {
        return R.layout.activity_busi_my_underway_order;
    }

    @Override
    protected void initView() {
        orderList=findViewById(R.id.lv_busi_my_underwayOrder_foodlist);
        refreshLayout=findViewById(R.id.swipe_busi_my_underwayOrder);
        sv=findViewById(R.id.sv_busi_my_underwayOrder);
    }
        ...
        orderList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(selectedItem instanceof Order){
                    ...
                    Intent intent=new Intent(BusiMyUnderwayOrderActivity.this, OrderInfo2Activity.class);
...
//        });
    ...
    public void loadData(){
        ...
        if (business != null) {
            orderList1 = OrderDAO.getBusiUnderwayOrder(business.getId());
        }
