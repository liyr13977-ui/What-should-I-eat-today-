...
public class UserCancelAdapter extends ArrayAdapter<Order> {
    private View view;
    private List<Order> listOrder;
    private Order order;

    public UserCancelAdapter(@NonNull Context context, List<Order> listOrder) {
        super(context, R.layout.adapter_user_cancel,listOrder);
    ...
    public View getView(int position, View view, @NonNull ViewGroup viewGroup) {
        if(view==null){
            ...
            view=inflater.inflate(R.layout.adapter_user_cancel,viewGroup,false);
        }
        order=listOrder.get(position);
        ...
        double totalAmount=totalPrice+delivery;
